...
po-update:
	...
	pybabel update -l es -w 120 --init-missing -i messages.pot -d codex_of_the_damned/translations
	pybabel update -l pt -w 120 --init-missing -i messages.pot -d codex_of_the_damned/translations
