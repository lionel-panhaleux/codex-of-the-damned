...
BASE_CONTEXT = {
    ...
    "POLITICAL": markupsafe.Markup('<span class="krcg-icon">2</span>'),
    "ALLY": markupsafe.Markup('<span class="krcg-icon">3</span>'),
    "COMBAT": markupsafe.Markup('<span class="krcg-icon">4</span>'),
    "EQUIPMENT": markupsafe.Markup('<span class="krcg-icon">5</span>'),
    "REFLEX": markupsafe.Markup('<span class="krcg-icon">6</span>'),
    "REACTION": markupsafe.Markup('<span class="krcg-icon">7</span>'),
    "RETAINER": markupsafe.Markup('<span class="krcg-icon">8</span>'),
    ...
    "OBF": markupsafe.Markup('<span class="krcg-icon">O</span>'),
    "obl": markupsafe.Markup('<span class="krcg-icon">ø</span>'),
    "OBL": markupsafe.Markup('<span class="krcg-icon">Ø</span>'),
    ...
    "brujah": markupsafe.Markup('<span class="krcg-clan">o</span>'),
    "brujah_legacy": markupsafe.Markup('<span class="krcg-clan">G</span>'),
    ...
    "gangrel_legacy": markupsafe.Markup('<span class="krcg-clan">L</span>'),
