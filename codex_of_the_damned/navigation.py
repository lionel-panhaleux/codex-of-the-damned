        ...
        Nav(
            ...
            children=[
                ...
                Nav(
                    ...
                    index=False,
                    children=[
                        Nav("Lasombra Politics"),
                        Nav("Piper War Ghoul '24"),
                        Nav("Qawiyya Caine"),
                    ],
                ),
                Nav(
                    lazy_gettext("Old Guard"),
                    index=False,
                    children=[
            ...
            children=[
                Nav(
                    ...
                    children=[
                        ...
                        Nav(lazy_gettext("Blood Sorcery")),
                        ...
                        Nav(lazy_gettext("Oblivion")),
                        Nav(lazy_gettext("Potence")),
                        Nav(lazy_gettext("Presence")),
                        Nav(lazy_gettext("Protean")),
                    ],
                ),
                Nav(
                    lazy_gettext("Sects"),
                ...
                Nav(
                    ...
                    children=[
                        ...
                        Nav(lazy_gettext("Nosferatu Antitribu")),
                        Nav(lazy_gettext("Ravnos")),
                        Nav(lazy_gettext("Ravnos (Legacy)")),
                        ...
                        Nav(lazy_gettext("Tremere Antitribu")),
                        Nav(lazy_gettext("True Brujah")),
                        Nav(lazy_gettext("Tzimisce")),
                        Nav(lazy_gettext("Tzimisce (Legacy)")),
                        Nav(lazy_gettext("Ventrue")),
                        Nav(lazy_gettext("Ventrue Antitribu")),
                    ],
                ),
            ],
        ),
