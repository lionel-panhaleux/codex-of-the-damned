		...
		Nav(
			...
			children=[
				...
				Nav(
					...
					index=False,
					children=[
						Nav(lazy_gettext("419 Operation")),
						Nav(lazy_gettext("Akunanse Classic")),
						Nav(lazy_gettext("Anson Grooming")),
						Nav(lazy_gettext("Anson Guns")),
						Nav(lazy_gettext("Anu Diptinatpa")),
						Nav(lazy_gettext("Armin the Hammer")),
						Nav(lazy_gettext("Army of Allah")),
						Nav(lazy_gettext("Aviary")),
						Nav(lazy_gettext("Ayo Igoli")),
						Nav(lazy_gettext("Baltimore Purge")),
						Nav(lazy_gettext("Better Gentlemen")),
						Nav(lazy_gettext("Big Cock")),
						Nav(lazy_gettext("Bima")),
						Nav(lazy_gettext("Brujah Debate")),
						Nav(lazy_gettext("Carna")),
						Nav(lazy_gettext("Carnivalesque")),
						Nav(lazy_gettext("Collier of Love")),
						Nav(lazy_gettext("Cybele Great Beast")),
						Nav(lazy_gettext("Cybele Maleficia")),
						Nav(lazy_gettext("Daughters")),
						Nav(lazy_gettext("Death Seekers")),
						Nav(lazy_gettext("Dekox Ultimus")),
						Nav(lazy_gettext("Dominarium")),
						Nav(lazy_gettext("Dragon's Breath Rounds")),
						Nav(lazy_gettext("Emerald Legionnaire")),
						Nav(lazy_gettext("Enkidu Multirush")),
						Nav(lazy_gettext("Euro Brujah")),
						Nav(lazy_gettext("Extrême Violence")),
						Nav(lazy_gettext("Family Business")),
						Nav(lazy_gettext("Fat Usurper")),
						Nav(lazy_gettext("Fear Factor")),
						Nav(lazy_gettext("Fear of the Dard")),
						Nav(lazy_gettext("First Tradition")),
						Nav(lazy_gettext("Frosties Gogo")),
						Nav(lazy_gettext("Ghede Typhonic Beast")),
						Nav(lazy_gettext("Girls Immortal Grapple")),
						Nav(lazy_gettext("Girls Will Find Inner Circle")),
						Nav(lazy_gettext("Guillaume Giovanni")),
						Nav(lazy_gettext("Hakuna Matata")),
						Nav(lazy_gettext("Hermanas")),
						Nav(lazy_gettext("Howler & Friends")),
						Nav(lazy_gettext("Imbued")),
						Nav(lazy_gettext("Isabel & Boys")),
						Nav(lazy_gettext("Kiev Circle")),
						Nav(lazy_gettext("Knave's Revenge")),
						Nav(lazy_gettext("Koudéta")),
						Nav(lazy_gettext("Legacy of Pander")),
						Nav(lazy_gettext("Lorrie Superstar")),
						Nav(lazy_gettext("Lutz's Coopt")),
						Nav(lazy_gettext("Malgorzata & Friends")),
						Nav(lazy_gettext("Malkavian Royalty")),
						Nav(lazy_gettext("Matasuntha")),
						Nav(lazy_gettext("Meat Shields")),
						Nav(lazy_gettext("Midcap DEM")),
						Nav(lazy_gettext("Miller Delmo")),
						Nav(lazy_gettext("Mono Valeren")),
						Nav(lazy_gettext("Muricia & Friends")),
						Nav(lazy_gettext("Nagagrinder")),
						Nav(lazy_gettext("Nakhtoreb")),
						Nav(lazy_gettext("Nephandii")),
						Nav(lazy_gettext("No Secret Box of Tools")),
						Nav(lazy_gettext("Nosferatu Royalty")),
						Nav(lazy_gettext("Nuriel")),
						Nav(lazy_gettext("Order 66")),
						Nav(lazy_gettext("Ozmo 94")),
						Nav(lazy_gettext("Palla Grande")),
						Nav(lazy_gettext("Piper War Ghoul")),
						Nav(lazy_gettext("Red Army")),
						Nav(lazy_gettext("Reversal")),
						Nav(lazy_gettext("Richter & Friends")),
						Nav(lazy_gettext("Rock Cats")),
						Nav(lazy_gettext("Sarrasine Velvet Tongue")),
						Nav(lazy_gettext("Seraph's Ambitions")),
						Nav(lazy_gettext("Sha's Threesome")),
						Nav(lazy_gettext("Shadow Court Satyrs")),
						Nav(lazy_gettext("Slaughtermanship")),
						Nav(lazy_gettext("Spell of Life")),
						Nav(lazy_gettext("Spirit Marionette")),
						Nav(lazy_gettext("Stanislava")),
						Nav(lazy_gettext("Storia di Buratino")),
						Nav(lazy_gettext("Summon a Shal")),
						Nav(lazy_gettext("Tariq Eats the World")),
						Nav(lazy_gettext("The Unnamed")),
						Nav(lazy_gettext("Tongue of the Serpent")),
						Nav(lazy_gettext("Torchon brûlant")),
						Nav(lazy_gettext("Trap Horrid")),
						Nav(lazy_gettext("Trapappa")),
						Nav(lazy_gettext("Tuna Tunnel")),
						Nav(lazy_gettext("Tunnel Runners")),
						Nav(lazy_gettext("Tupdogs")),
						Nav(lazy_gettext("Turbo Sensory")),
						Nav(lazy_gettext("Ublo's Harem")),
						Nav(lazy_gettext("Una Circus")),
						Nav(lazy_gettext("Unacceptable Boon")),
						Nav(lazy_gettext("Unmada Crescendo")),
						Nav(lazy_gettext("Warding Pan")),
						Nav(lazy_gettext("Weenie ANI")),
						Nav(lazy_gettext("Weenie AUS")),
						Nav(lazy_gettext("Weenie DEM")),
						Nav(lazy_gettext("Weenie PRE")),
						Nav(lazy_gettext("Weenie VIC")),
					],
				),
			],
		),
